...
namespace SD.Services.Tasks
{
    ...
    public partial class Task
    {
        ...
        public Task(Sys_Backgroundtask task)
        {
            this.Type = task.Type;
        ...
        public void Execute(bool throwException = false, bool dispose = true)
        {
            ...
            var scheduleTaskService = EngineContext.Current.ContainerManager.Resolve<IBackgroundTaskService>("", scope);
            ...
            catch (Exception exc)
            {
                ...
                //log error
                //var logger = EngineContext.Current.ContainerManager.Resolve<ILogService>("", scope);
