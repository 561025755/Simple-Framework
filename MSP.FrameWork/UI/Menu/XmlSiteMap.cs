...
namespace SD.FrameWork.UI.Menu
{
    public class XmlSiteMap
    {
        ...
        public static int MediaType { get; set; }
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            siteMapNode.New = GetStringValueFromAttribute(xmlNode, "new") == null ? false : bool.Parse(GetStringValueFromAttribute(xmlNode, "new"));
            ...
            if (!string.IsNullOrEmpty(controllerName) && !string.IsNullOrEmpty(actionName))
            {
                ...
                siteMapNode.RouteValues = new RouteValueDictionary()
                                          {
                                              {"area", string.IsNullOrWhiteSpace(siteMapNode.Area)?"":siteMapNode.Area}
                                          };
            }
