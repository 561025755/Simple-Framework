...
Designer.addFunction("selectAll",
function () {
...
Designer.addFunction("setFontStyle",
function (d) {
...
Designer.addFunction("setShapeStyle",
function (d) {
    var c = Utils.getSelected();
    if (c.length == 0) {
        return
...
Designer.addFunction("setLineStyle",
function (f) {
...
Designer.addFunction("setFillStyle",
function (f) {
    var e = Utils.getSelected();
    if (e.length == 0) {
        return
...
Designer.addFunction("setLinkerType",
function (e) {
...
Designer.addFunction("matchSize",
function (l) {
    var c = Utils.getSelected();
    if (c.length == 0 || !l) {
        return
...
Designer.addFunction("alignShapes",
function (c) {
...
Designer.addFunction("distributeShapes",
function (o) {
...
Designer.addFunction("layerShapes",
function (m) {
...
Designer.addFunction("lockShapes",
function () {
...
Designer.addFunction("unlockShapes",
function () {
...
Designer.addFunction("setPageStyle",
function (a) {
    Model.updatePage(a)
});
Designer.addFunction("setReadonly",
function (a) {
    if (typeof a != "boolean") {
        return
    }
...
Designer.addFunction("zoomIn",
function () {
    var a = Designer.config.scale;
    var b = a + 0.1;
    Designer.setZoomScale(b)
});
Designer.addFunction("zoomOut",
function () {
    var a = Designer.config.scale;
    var b = a - 0.1;
    Designer.setZoomScale(b)
});
Designer.addFunction("setZoomScale",
function (e) {
    if (e < 0.25) {
        e = 0.25
    }
...
Designer.addFunction("setShapeProps",
function (h, b) {
    if (!b) {
        b = Utils.getSelected()
    }
...
Designer.addFunction("addDataAttribute",
function (a) {
...
Designer.addFunction("updateDataAttribute",
function (f) {
    var c = Utils.getSelectedIds();
    var b = Model.getShapeById(c[0]);
    if (!b.dataAttributes) {
...
Designer.addFunction("getDataAttrById",
function (e) {
    var c = Utils.getSelectedIds();
    var b = Model.getShapeById(c[0]);
    if (!b.dataAttributes) {
...
Designer.addFunction("getDefaultDataAttrByName",
function (d) {
    var c = Utils.getSelectedIds();
    var b = Model.getShapeById(c[0]);
    if (!b.dataAttributes) {
...
Designer.addFunction("deleteDataAttribute",
function (e) {
    var c = Utils.getSelectedIds();
    var b = Model.getShapeById(c[0]);
    if (!b.dataAttributes) {
...
Designer.addFunction("setSchema",
function (schemaCategories, callback) {
