Designer.events.addEventListener("initialized",
function () {
    if (localRuntime) {
...
Designer.events.addEventListener("create",
function (a) { });
var createdTip = false;
Designer.events.addEventListener("created",
function (a) {
    if (createdTip) {
...
Designer.events.addEventListener("linkerCreating",
function (a) { });
Designer.events.addEventListener("linkerCreated",
function (a) { });
Designer.events.addEventListener("selectChanged",
function () {
    UI.update();
    Dock.update();
    UI.showShapeOptions()
});
Designer.events.addEventListener("clipboardChanged",
function (a) {
    if (a > 0) {
...
Designer.events.addEventListener("undoStackChanged",
function (a) {
    if (a == 0) {
...
Designer.events.addEventListener("redoStackChanged",
function (a) {
    if (a == 0) {
...
Designer.events.addEventListener("beforeResize",
function (a) {
    var c = a.shapes;
    var b = a.minSize;
    var f = a.dir;
...
Designer.events.addEventListener("resizing",
function (b) {
    var n = b.shape;
    var e = b.dir;
    var g = b.offset;
...
Designer.events.addEventListener("beforeRemove",
function (c) {
    var n = {};
...
Designer.events.addEventListener("removed",
function (b) {
    var c = b.shapes;
    var m = b.range;
    var s = b.changedIds;
...
Designer.events.addEventListener("shapeChanged",
function (a) { });