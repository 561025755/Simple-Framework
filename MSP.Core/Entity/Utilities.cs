...
using System.Web;
using SD.Core.ComponentModel;
using System.IO;

namespace SD.Core.Entity
{
    /// <summary>
    ...
    public partial class Utilities
    {
        ...
        /// <returns></returns>
        public static string HashSum(byte[] fileBinary)
        {
            byte[] hash = new MD5CryptoServiceProvider().ComputeHash(fileBinary);
        ...
        /// <returns></returns>
        public static string HashSum(Stream inputStream)
        {
            byte[] hash = new MD5CryptoServiceProvider().ComputeHash(inputStream);
        ...
        public static string HashSum(string inputString)
        {
            var inputBytes = UTF8Encoding.Default.GetBytes(inputString);

            byte[] hash = new MD5CryptoServiceProvider().ComputeHash(inputBytes);
        ...
        public static string ParseGeoPoint(string geoPointText)
        {
