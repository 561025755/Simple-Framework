...
namespace SD.Core.Sorting
{
	...
	public static class SortExtensions
    {
        ...
        /// <returns></returns>
        public static string Q(this SortOptions sort, string defaultCol = "", string defaultOrder = "")
        {
            if (null == sort)
            {
                var defaultSort = new SortOptions { Column = defaultCol, Direction = defaultOrder };

                return defaultSort.SQL;
            }
            else
            {
                return sort.SQL;
